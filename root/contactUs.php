...
<div class="col-md-4">
 ...
 <div class="contact-info">
   <div>
          <img src="../assets/images/th (1).jpg" width="25" height="25">
    <a href="tel:111258259">111-258-259</a>
          </div>
    <br>
       <div>
          <img src="../assets/images/th (2).jpg" width="25" height="25">
           <a href="mailto:#">clucks@cluckys.pk</a>
             </div>
          <br>
     <div>
   <img src="../assets/images/th (3).jpg" width="25" height="25">
...
$stmt = $conn->prepare("INSERT INTO contacts (`Name`, `Email`, `phone_No`, `Message`) VALUES (:name, :email,:phone_No,:mes)");
$stmt->bindParam(':name', $Name);
$stmt->bindParam(':email', $Email);
$stmt->bindParam(':phone_No', $phone_No);
$stmt->bindParam(':mes', $Message);
    $stmt->execute();
    }
